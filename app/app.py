...
def main():
    ...
    with st.container():
        ...
        st.image("https://w0.peakpx.com/wallpaper/617/1018/HD-wallpaper-rock-paper-scissors-showdowm-rock-scissors-rock-paper-scissors-paper-blue-jan-ken-pon.jpg")
